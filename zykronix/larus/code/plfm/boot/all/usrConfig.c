...
--------------------
20m,20oct04,vvv  fixed warning (SPR #102122)
20l,30sep04,dlk  Added INCLUDE_NBIO_LOG.
20k,24sep04,hch  Merge from Medusa I4 to I5 for USB components
20j,20sep04,ami  NET2280 tested on High Speed
20i,19sep04,kc   Merged SPR#98433 fix to address the ftp and telnet security
                 issue.
20h,24aug04,hch  remove the duplicate initialization of USB peripheral mass
                 storage driver.
20g,16aug04,pdg  Fix for long booting time of OHCI and EHCI
20f,12aug04,pmr  merge from USB integration branch.
20e,09aug04,hch  added USB peripheral keyboard and mouse initialization
		 moved the pegasus driver initialization after usrNetInit
20d,04aug04,hch  add USB peripheral mass storage driver initialization
20c,23sep03,nrv  Removing code for sys(Ohci/Ehci/Uhci)PciInit
20b,17sep03,nrv  Updating for USB2 stack
20a,24jun04,syy  Remove extra defines inside INCLUDE_WINDVIEW
19z,08mar04,rp   updated for dual stack
...
#   endif /* INCLUDE_DOSFS_FMT */
    ...
    sysIsp1582PciDisconnect ();   /* PHILIPS1582 initialization */
#endif
...
#define WDB_COMM_TYPE_STR "Unknown"
    ...
    printf ("\n\n");
    printf ("%23s\n\n", runtimeName);
    printf ("Copyright 1984-2004  Wind River Systems, Inc.\n\n");
    printf ("            CPU: %s\n", sysModel ());
