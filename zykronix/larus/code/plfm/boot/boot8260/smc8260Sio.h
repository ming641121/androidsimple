...
extern int sysCraftBaudRate;
extern int SMCMR_STD_MODE;
extern PPC8260SMC_CHAN ppcChn[];

extern STATUS smc8260Ioctl (PPC8260SMC_CHAN *pChan,int request,int arg);
extern void   smc8260ResetChannel (PPC8260SMC_CHAN *pChan );
extern STATUS smc8260ChangeOption( PPC8260SMC_CHAN *pChan );
