...
#define M8260_GFEMR1(base)  (CAST(VUINT8 *)((base) + 0x11390))  /* Fcc1 General Extended Mode */
#define M8260_GFEMR2(base)  (CAST(VUINT8 *)((base) + 0x113B0))  /* Fcc2 General Extended Mode */
...
#define M8260_FPSMR_ETH_RMII 0x00020000          /* RMII mode */
