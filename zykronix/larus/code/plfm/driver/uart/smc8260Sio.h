...
extern void smc8260Int1(PPC8260SMC_CHAN *pChan);
extern void   smc8260Startup2 (PPC8260SMC_CHAN *);
extern int smc8260CallbackInstall2 (SIO_CHAN *, int, STATUS (*)(), void *);
extern STATUS smc8260Ioctl2 (PPC8260SMC_CHAN *pChan,int request,int arg);
extern void smcSerialSend( char *Cmd ,int cmdLen,int port);
...
/* added globle valuables/rountine */
void smcSerialReset( void );
