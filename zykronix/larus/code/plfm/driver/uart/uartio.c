...
void m8260SioDevInit
    ...
    VINT16  *pSCCM = (VINT16 *) (immrVal + M8260_SCC_BASE + M8260_SCCM_OFFSET +(scc * M8260_SCC_OFFSET_NEXT_SCC));
/*
...
void m8260SioResetChannel(M8260_SCC_CHAN *pSccChan)
    ...
    VINT16 *pSCCE = (VINT16 *) (immrVal + M8260_SCC_BASE + M8260_SCCE_OFFSET +
		      	        (scc * M8260_SCC_OFFSET_NEXT_SCC)); /* added by Betta */ 
    ...
    *pSCCE |= M8260_SCC_UART_SCCX_ALL_EVENTS;  /* added by Betta */
...
#if 0
    * pSccChan->pRBASE = 0x00 + (0x100 * scc);
#endif
    *pSccChan->pRBASE = (VINT16)( (UINT32)(pSccChan->pBdBase +  M8260_SCC_RCV_BD_OFF) ) ;
...
#if 0
    * pSccChan->pTBASE = 0x08 + (0x100 * scc); /* original code */
#endif

       *pSccChan->pTBASE = (VINT16)((UINT32)(pSccChan->pBdBase +  M8260_SCC_TX_BD_OFF)) ; /* added by Betta */
...
#if LOOPBACK_MODE		 
		 M8260_SCC_GSMRL_LOOPBACK | /* M8260_SCC_GSMRL_LOOPBACK is for loopback testing */
#endif		 
...
#endif
    * pRFCR = 0x10;	/* supervisor data access */

    * pTFCR = 0x10;	/* supervisor data access */
    * pMRBLR = 1;
...
STATUS m8260SioIoctl
    ...
    UINT32      immrVal = pSccChan->immrVal;    /* holder for the immr value */
    VINT32 *pBRGC = (VINT32 *) (immrVal + M8260_BRGC_BASE + (scc * M8260_BRGC_OFFSET_NEXT_BRGC));
   ...
   static int received_slashR=0;
	...
	while (!(bdStatus & M8260_SCC_UART_RX_BD_EMPTY)) 
     ...
     if (scc!=1)   
     {
       ...
       if (fgUartReadyToRead[scc])	
       { 
          msgQSend(uartMsgQ[scc], &outChar, 1, NO_WAIT, MSG_PRI_NORMAL);	     	
       	  if ( outChar == '\n') 
       	  { 
       
       	    fgUartReadyToRead[scc] = 0;
