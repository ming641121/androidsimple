    ...
    char *filename)
{
    ...
    while ((secPosture < 1) || (secPosture > 3)) {
        printf("The following security postures are available (see RFCs 2574 and 2575):\n"
               "    1) Minimum-secure\n"
               "    2) Semi-secure\n"
               "    3) Very-secure\n"
    ...
    if (secPosture == 1) {
        sr_fprintf(cfgp, "communityEntry  localSnmpID public visitor "
                         "localSnmpID default - nonVolatile\n"
                         "communityEntry  localSnmpID sysadmin initial "
                         "localSnmpID default - nonVolatile\n");
    }
    ...
    if (secPosture == 2) {
        sr_fprintf(cfgp, "communityEntry  localSnmpID public visitor "
                         "localSnmpID default - nonVolatile\n"
                         "communityEntry  localSnmpID sysadmin visitor "
                         "localSnmpID default - nonVolatile\n");
    }
