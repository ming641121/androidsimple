...
#if (defined(I_vacmGroupName) && defined(I_vacmAccessEntryIndex_vacmGroupName))
    { I_vacmAccessEntryIndex_vacmGroupName, T_var_octet, -1 },
#endif	/* (defined(I_vacmGroupName) && defined(I_vacmAccessEntryIndex_vacmGroupName)) */
...
{
#if ((((! ( defined(I_vacmGroupName) ) || ! ( defined(I_vacmAccessEntryIndex_vacmGroupName) )) || ! ( defined(I_vacmAccessContextPrefix) )) || ! ( defined(I_vacmAccessSecurityModel) )) || ! ( defined(I_vacmAccessSecurityLevel) ))
    return NULL;
#else	/* ((((! ( defined(I_vacmGroupName) ) || ! ( defined(I_vacmAccessEntryIndex_vacmGroupName) )) || ! ( defined(I_vacmAccessContextPrefix) )) || ! ( defined(I_vacmAccessSecurityModel) )) || ! ( defined(I_vacmAccessSecurityLevel) )) */
    return (v_get(incoming, object, searchType, contextInfo, serialNum,
                  (SrGetInfoEntry *) &vacmAccessEntryGetInfo));
#endif	/* ((((! ( defined(I_vacmGroupName) ) || ! ( defined(I_vacmAccessEntryIndex_vacmGroupName) )) || ! ( defined(I_vacmAccessContextPrefix) )) || ! ( defined(I_vacmAccessSecurityModel) )) || ! ( defined(I_vacmAccessSecurityLevel) )) */
}
...
Clone_vacmAccessEntry(vacmAccessEntry_t *vacmAccessEntry)
{
    ...
    return SrCloneFamily(vacmAccessEntry,
