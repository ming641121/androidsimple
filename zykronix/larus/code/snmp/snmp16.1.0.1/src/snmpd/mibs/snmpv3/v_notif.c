...
Clone_snmpNotifyEntry(snmpNotifyEntry_t *snmpNotifyEntry)
{
    ...
    return SrCloneFamily(snmpNotifyEntry,
...
#if (defined(I_snmpTargetParamsName) && defined(I_snmpNotifyFilterProfileEntryIndex_snmpTargetParamsName))
    { I_snmpNotifyFilterProfileEntryIndex_snmpTargetParamsName, T_octet, -1 },
#endif	/* (defined(I_snmpTargetParamsName) && defined(I_snmpNotifyFilterProfileEntryIndex_snmpTargetParamsName)) */
    { -1, -1, -1 }
};
...
#if (! ( defined(I_snmpTargetParamsName) ) || ! ( defined(I_snmpNotifyFilterProfileEntryIndex_snmpTargetParamsName) ))
    return NULL;
#else	/* (! ( defined(I_snmpTargetParamsName) ) || ! ( defined(I_snmpNotifyFilterProfileEntryIndex_snmpTargetParamsName) )) */
    return (v_get(incoming, object, searchType, contextInfo, serialNum,
...
Clone_snmpNotifyFilterProfileEntry(snmpNotifyFilterProfileEntry_t *snmpNotifyFilterProfileEntry)
{
    /* Clone function is not used by auto-generated */
    /* code, but may be used by user code */
    return SrCloneFamily(snmpNotifyFilterProfileEntry,
...
#if (defined(I_snmpNotifyFilterProfileName) && defined(I_snmpNotifyFilterEntryIndex_snmpNotifyFilterProfileName))
    { I_snmpNotifyFilterEntryIndex_snmpNotifyFilterProfileName, T_var_octet, -1 },
#endif	/* (defined(I_snmpNotifyFilterProfileName) && defined(I_snmpNotifyFilterEntryIndex_snmpNotifyFilterProfileName)) */
...
snmpNotifyFilterEntry_get(OID *incoming, ObjectInfo *object, int searchType,
                          ContextInfo *contextInfo, int serialNum)
{
#if ((! ( defined(I_snmpNotifyFilterProfileName) ) || ! ( defined(I_snmpNotifyFilterEntryIndex_snmpNotifyFilterProfileName) )) || ! ( defined(I_snmpNotifyFilterSubtree) ))
    return NULL;
#else	/* ((! ( defined(I_snmpNotifyFilterProfileName) ) || ! ( defined(I_snmpNotifyFilterEntryIndex_snmpNotifyFilterProfileName) )) || ! ( defined(I_snmpNotifyFilterSubtree) )) */
    return (v_get(incoming, object, searchType, contextInfo, serialNum,
                  (SrGetInfoEntry *) &snmpNotifyFilterEntryGetInfo));
#endif	/* ((! ( defined(I_snmpNotifyFilterProfileName) ) || ! ( defined(I_snmpNotifyFilterEntryIndex_snmpNotifyFilterProfileName) )) || ! ( defined(I_snmpNotifyFilterSubtree) )) */
}
...
Clone_snmpNotifyFilterEntry(snmpNotifyFilterEntry_t *snmpNotifyFilterEntry)
{
    /* Clone function is not used by auto-generated */
    /* code, but may be used by user code */
    return SrCloneFamily(snmpNotifyFilterEntry,
