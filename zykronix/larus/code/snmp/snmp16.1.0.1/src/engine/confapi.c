    ...
    SR_UINT32 FLAG)
{
  ...
  /* build the search structure */
    ...
    if ( (snmpEngineID == NULL) || (strcmp((char*)snmpEngineID->octet_ptr,"localSnmpID") == 0) 
       ...
       snmpEngineID = SrGetSnmpID(0, (void *)0);           /* get default agt ID */
    ...
    if ( FLAG == 1 || FLAG == 2 )   {
        ...
        if( (strcmp(target, "-") == 0) || (strcmp(target, "NULL") == 0) ){
        ...
        if(strcmp(privprot,"usmNoPrivProtocol") == 0)  {
         ...
         if (uue->priv_secret != NULL) {
            ...
            if(strcmp(authprot,"usmNoAuthProtocol") == 0)  {
               ...
               uue->priv_secret =  SrTextPasswordToLocalizedKey(
                        SR_PW2KEY_ALGORITHM_MD5,uue->usmUserEngineID,privpass);
            }
#endif    /* SR_MD5_HASH_ALGORITHM  */
#ifdef SR_SHA_HASH_ALGORITHM
            else if (strcmp(authprot,"usmHMACSHAAuthProtocol") == 0)  {
               ...
               uue->priv_secret =  SrTextPasswordToLocalizedKey(
                        SR_PW2KEY_ALGORITHM_SHA,uue->usmUserEngineID,privpass);
            }
#endif   /* SR_SHA_HASH_ALGORITHM */
        }
#endif /* SR_NO_PRIVACY */
...
{ 
   ...
   if (FLAG == 1 || FLAG == 2) {
     ...
     if (contextEngineID == NULL ||
       ...
       sce->snmpCommunityContextEngineID = SrGetSnmpID(0, (void *)0);
     }
     else {
