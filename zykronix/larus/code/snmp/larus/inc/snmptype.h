...
/*
 * The stsPerfMonManual family. 
 */


typedef
struct _stsPerfMonManual_t {
...
extern VarBind * stsPerfMonManual_get
    SR_PROTOTYPE((OID *incoming,
                  ObjectInfo *object,
                  int searchType,
                  ContextInfo *contextInfo,
...
extern int stsPerfMonManual_test
    SR_PROTOTYPE((OID *incoming,
                  ObjectInfo *object,
                  ObjectSyntax *value,
                  doList_t *doHead,
...
extern int stsPerfMonManual_ready
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));

extern int stsPerfMonManual_set
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));

extern void stsPerfMonManual_free
    SR_PROTOTYPE((stsPerfMonManual_t *data));

extern stsPerfMonManual_t *new_k_stsPerfMonManual_get
    SR_PROTOTYPE((int serialNum,
                  ContextInfo *contextInfo,
                  int nominator,
                  int searchType,
...
extern stsPerfMonManual_t *k_stsPerfMonManual_get
    SR_PROTOTYPE((int serialNum,
                  ContextInfo *contextInfo,
                  int nominator));

extern int k_stsPerfMonManual_test
    SR_PROTOTYPE((ObjectInfo *object,
                  ObjectSyntax *value,
                  doList_t *dp,
                  ContextInfo *contextInfo));

extern int k_stsPerfMonManual_set
    SR_PROTOTYPE((stsPerfMonManual_t *data,
                  ContextInfo *contextInfo,
                  int function));

extern int k_stsPerfMonManual_ready
    SR_PROTOTYPE((ObjectInfo *object,
                  ObjectSyntax *value,
                  doList_t *doHead,
                  doList_t *dp));

extern int stsPerfMonManual_undo
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));

extern stsPerfMonManual_t *Clone_stsPerfMonManual
    SR_PROTOTYPE((stsPerfMonManual_t *data));



/*
 * The stsCommStr family. 
 */


typedef
struct _stsCommStr_t {
        OctetString     *stsReadOnlyCommStr;
        OctetString     *stsReadWriteCommStr;
        char            valid[1];
} stsCommStr_t;

extern VarBind * stsCommStr_get
    SR_PROTOTYPE((OID *incoming,
                  ObjectInfo *object,
                  int searchType,
                  ContextInfo *contextInfo,
...
extern int stsCommStr_ready
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));

extern int stsCommStr_set
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));

extern void stsCommStr_free
    SR_PROTOTYPE((stsCommStr_t *data));

extern stsCommStr_t *new_k_stsCommStr_get
    SR_PROTOTYPE((int serialNum,
                  ContextInfo *contextInfo,
                  int nominator,
                  int searchType,
...
extern stsCommStr_t *k_stsCommStr_get
    SR_PROTOTYPE((int serialNum,
                  ContextInfo *contextInfo,
                  int nominator));

extern int k_stsCommStr_test
    SR_PROTOTYPE((ObjectInfo *object,
                  ObjectSyntax *value,
                  doList_t *dp,
                  ContextInfo *contextInfo));

extern int k_stsCommStr_set
    SR_PROTOTYPE((stsCommStr_t *data,
                  ContextInfo *contextInfo,
                  int function));

extern int k_stsCommStr_ready
    SR_PROTOTYPE((ObjectInfo *object,
                  ObjectSyntax *value,
                  doList_t *doHead,
                  doList_t *dp));

extern int stsCommStr_undo
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));

extern stsCommStr_t *Clone_stsCommStr
    SR_PROTOTYPE((stsCommStr_t *data));
...
struct _stsOscillatorEntry_t {
        ...
        SR_INT32        stsOscillatorSwitchState;
        SR_INT32        stsOscillatorStatus;
        SR_INT32        stsOscillatorRedStatus;
        char            valid[2];
...
struct _stsPerfMonEntry_t {
        ...
        SR_INT32        stsPerfMonInputMonValue;
...
struct _stsOutputCardEntry_t {
        ...
        SR_INT32        stsOutputRedEnableState;
...
/*
 * The stsClockPriEntry family. 
 */


typedef
struct _stsClockPriEntry_t {
        SR_INT32        stsClockPriIndex;
        SR_INT32        stsClockPriSetting;
        char            valid[1];
} stsClockPriEntry_t;

extern VarBind * stsClockPriEntry_get
    SR_PROTOTYPE((OID *incoming,
                  ObjectInfo *object,
                  int searchType,
                  ContextInfo *contextInfo,
...
extern int stsClockPriEntry_test
    SR_PROTOTYPE((OID *incoming,
                  ObjectInfo *object,
                  ObjectSyntax *value,
                  doList_t *doHead,
...
extern int stsClockPriEntry_ready
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));

extern int stsClockPriEntry_set
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));
...
extern stsClockPriEntry_t *new_k_stsClockPriEntry_get
    SR_PROTOTYPE((int serialNum,
                  ContextInfo *contextInfo,
                  int nominator,
                  int searchType,
                  stsClockPriEntry_t *stsClockPriEntryData));

extern stsClockPriEntry_t *k_stsClockPriEntry_get
    SR_PROTOTYPE((int serialNum,
                  ContextInfo *contextInfo,
                  int nominator,
                  int searchType,
...
extern int k_stsClockPriEntry_test
    SR_PROTOTYPE((ObjectInfo *object,
                  ObjectSyntax *value,
                  doList_t *dp,
                  ContextInfo *contextInfo));

extern int k_stsClockPriEntry_set
    SR_PROTOTYPE((stsClockPriEntry_t *data,
                  ContextInfo *contextInfo,
                  int function));

extern int k_stsClockPriEntry_ready
    SR_PROTOTYPE((ObjectInfo *object,
                  ObjectSyntax *value,
                  doList_t *doHead,
                  doList_t *dp));

extern int stsClockPriEntry_undo
    SR_PROTOTYPE((doList_t *doHead,
                  doList_t *doCur,
                  ContextInfo *contextInfo));

extern stsClockPriEntry_t *Clone_stsClockPriEntry
    SR_PROTOTYPE((stsClockPriEntry_t *data));

extern int k_stsClockPriEntry_set_defaults
    SR_PROTOTYPE((doList_t *dp));
