...
CARM	= -Iinclude -D_For_BB -g --dwarf2 --cpu ARM926EJ-S
...
CARM_OBJS	= 		  For_BB\SYSUtility.o For_BB\SPI.o For_BB\main.o \
		  For_BB\retarget.o 
...
AARM	= -iinclude -pd "For_BB SETL {TRUE}" -g --dwarf2 --cpu ARM926EJ-S
...
AARM_OBJS	= 		  For_BB\heap.o For_BB\init.o For_BB\stack.o \
		  For_BB\vectors.o 
...
$(PROGRAM):     $(OBJS) $(DEPEND) $(O_DEPEND) $(MAKENAME)
	...
	fromelf -c -o .\For_BB\M005.dis .\For_BB\M005.axf
	fromelf --nodebug --elf -o .\For_BB\M005.elf .\For_BB\M005.axf
...
For_BB\SYSUtility.o: .\sources\SYSUtility.c $(INCLUDE_GLOBAL_H)
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c \
	 .\sources\SYSUtility.c $(CARM) -o For_BB\SYSUtility.o
For_BB\SPI.o: .\sources\SPI.c $(INCLUDE_GLOBAL_H)
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c .\sources\SPI.c \
	 $(CARM) -o For_BB\SPI.o
For_BB\main.o: .\sources\main.c $(INCLUDE_GLOBAL_H) include\declare.h
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c .\sources\main.c \
	 $(CARM) -o For_BB\main.o
For_BB\retarget.o: .\sources\retarget.c
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c \
	 .\sources\retarget.c $(CARM) -o For_BB\retarget.o
For_BB\heap.o: .\sources\heap.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_BB\heap.o .\sources\heap.s
For_BB\init.o: .\sources\init.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_BB\init.o .\sources\init.s
For_BB\stack.o: .\sources\stack.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_BB\stack.o .\sources\stack.s
For_BB\vectors.o: .\sources\vectors.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_BB\vectors.o .\sources\vectors.s
