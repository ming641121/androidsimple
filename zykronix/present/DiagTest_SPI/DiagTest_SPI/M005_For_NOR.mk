...
CARM	= -Iinclude -D_For_NOR -g --dwarf2 --cpu ARM926EJ-S
...
CARM_OBJS	= 		  For_NOR\SYSUtility.o For_NOR\SPI.o For_NOR\main.o \
		  For_NOR\retarget.o 
...
AARM	= -iinclude -pd "For_NOR SETL {TRUE}" -g --dwarf2 --cpu ARM926EJ-S
...
AARM_OBJS	= 		  For_NOR\heap.o For_NOR\init.o For_NOR\stack.o \
		  For_NOR\vectors.o 
...
EXTHDRS		=
HDRS		=
LDFLAGS		=  --info totals --entry 0xFFFF0000 --scatter scat_ROM_Hi.scf 
...
$(PROGRAM):     $(OBJS) $(DEPEND) $(O_DEPEND) $(MAKENAME)
	...
	fromelf -c -o .\For_NOR\M005.dis .\For_NOR\M005.axf
	fromelf --bin -o .\For_NOR\M005.bin .\For_NOR\M005.axf
	fromelf --vhx --16x1 -o .\For_NOR\M005_16.vhx .\For_NOR\M005.axf
...
For_NOR\SYSUtility.o: .\sources\SYSUtility.c $(INCLUDE_GLOBAL_H)
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c \
	 .\sources\SYSUtility.c $(CARM) -o For_NOR\SYSUtility.o
For_NOR\SPI.o: .\sources\SPI.c $(INCLUDE_GLOBAL_H)
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c .\sources\SPI.c \
	 $(CARM) -o For_NOR\SPI.o
For_NOR\main.o: .\sources\main.c $(INCLUDE_GLOBAL_H) include\declare.h
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c .\sources\main.c \
	 $(CARM) -o For_NOR\main.o
For_NOR\retarget.o: .\sources\retarget.c
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c \
	 .\sources\retarget.c $(CARM) -o For_NOR\retarget.o
For_NOR\heap.o: .\sources\heap.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_NOR\heap.o .\sources\heap.s
For_NOR\init.o: .\sources\init.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_NOR\init.o .\sources\init.s
For_NOR\stack.o: .\sources\stack.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_NOR\stack.o .\sources\stack.s
For_NOR\vectors.o: .\sources\vectors.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_NOR\vectors.o .\sources\vectors.s
