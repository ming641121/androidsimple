...
CARM	= -Iinclude -D_For_NAND -g --dwarf2 --cpu ARM926EJ-S
...
CARM_OBJS	= 		  For_NAND\SYSUtility.o For_NAND\SPI.o \
		  For_NAND\main.o For_NAND\retarget.o 
...
AARM	= -iinclude -pd "For_NAND SETL {TRUE}" -g --dwarf2 --cpu ARM926EJ-S
...
AARM_OBJS	= 		  For_NAND\heap.o For_NAND\init.o For_NAND\stack.o \
		  For_NAND\vectors.o 
...
EXTHDRS		=
HDRS		=
LDFLAGS		=  --info totals --entry 0x00000000 --scatter scat_RAM_0.scf 
...
$(PROGRAM):     $(OBJS) $(DEPEND) $(O_DEPEND) $(MAKENAME)
	...
	fromelf -c -o .\For_NAND\M005.dis .\For_NAND\M005.axf
	fromelf --bin -o .\For_NAND\M005.bin .\For_NAND\M005.axf
...
For_NAND\SYSUtility.o: .\sources\SYSUtility.c $(INCLUDE_GLOBAL_H)
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c \
	 .\sources\SYSUtility.c $(CARM) -o For_NAND\SYSUtility.o
For_NAND\SPI.o: .\sources\SPI.c $(INCLUDE_GLOBAL_H)
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c .\sources\SPI.c \
	 $(CARM) -o For_NAND\SPI.o
For_NAND\main.o: .\sources\main.c $(INCLUDE_GLOBAL_H) include\declare.h
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c .\sources\main.c \
	 $(CARM) -o For_NAND\main.o
For_NAND\retarget.o: .\sources\retarget.c
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armcc -c \
	 .\sources\retarget.c $(CARM) -o For_NAND\retarget.o
For_NAND\heap.o: .\sources\heap.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_NAND\heap.o .\sources\heap.s
For_NAND\init.o: .\sources\init.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_NAND\init.o .\sources\init.s
For_NAND\stack.o: .\sources\stack.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_NAND\stack.o .\sources\stack.s
For_NAND\vectors.o: .\sources\vectors.s
	c:\progra~1\arm\rvct\programs\2.1\498\win_32~1\armasm $(AARM) -o \
	 For_NAND\vectors.o .\sources\vectors.s
